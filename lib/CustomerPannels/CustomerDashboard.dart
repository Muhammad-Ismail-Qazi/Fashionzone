              ...
              children: [
                    ...
                    child: TextField(
                      decoration: InputDecoration(
                        ...
                        suffixIcon: GestureDetector(
                          ...
                          child: IconButton(
                            icon: const Icon(Icons.search, color: Color.fromARGB(247, 84, 74, 158)),
                            onPressed: () {
                              // Handle button press here
                              // Add your desired functionality when the icon button is pressed
                            },
                ...
                SingleChildScrollView(
                  ...
                  child: Row(
                    children: [
                      ...
                      MyCustomCard_Component(salonImagePath:'images/topsalon1.jpeg',salonLogoPath: 'images/logo.png',salonName: 'BeautyXone',stars: '4.5', ),
                      MyCustomCard_Component(salonImagePath: 'images/topsalon2.jpeg',salonName: 'Style',salonLogoPath: 'images/logo1.jpeg',stars: '4.3'),
                      MyCustomCard_Component(salonImagePath:'images/topsalon1.jpeg',salonLogoPath: 'images/logo.png',salonName: 'BeautyXone',stars: '4.5', ),
                      MyCustomCard_Component(salonImagePath: 'images/topsalon2.jpeg',salonName: 'Style',salonLogoPath: 'images/logo1.jpeg',stars: '4.3'),
                      MyCustomCard_Component(salonImagePath: 'images/topsalon3.jpeg',salonName: 'Beauty Balon',stars: '4.0',salonLogoPath: 'images/logo2.jpeg'),
                      MyCustomCard_Component(salonImagePath: 'images/topsalon3.jpeg',salonName: 'Beauty Balon',stars: '4.0',salonLogoPath: 'images/logo2.jpeg'),
                    ],
                  ),
                ),
                ...
                // near you portion
                 SingleChildScrollView(
                  ...
                  child: Row(
                    children: [
                      MyCustomListTileComponent(listTileLogoPath: 'images/logo1.jpeg',listTileSalonName: 'FashionZone'),
                      MyCustomListTileComponent(listTileSalonName: 'BeautyTime',listTileLogoPath: 'images/logo2.jpeg'),
                      MyCustomListTileComponent(listTileLogoPath: 'images/logo.png',listTileSalonName: 'StyleXone'),
                      MyCustomListTileComponent(listTileLogoPath: 'images/logo1.jpeg',listTileSalonName: 'FashionZone'),
                    ],
                  ),
                ),
